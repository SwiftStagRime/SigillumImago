...
open class SecureStorageException(message: String, cause: Throwable? = null) :
...
class StorageIOException(message: String, cause: Throwable? = null) :
    SecureStorageException(message, cause)

class MasterKeyUnavailableException(message: String, cause: Throwable? = null) :
    SecureStorageException(message, cause)

class DataNotFoundException(message: String, cause: Throwable? = null) :
    SecureStorageException(message, cause)